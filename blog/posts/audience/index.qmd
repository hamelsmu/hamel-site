...
## 6. Use Social Cards, Thumbnails, and Screenshots

Thumbnails and social cards are vital for visibility on social media. Do not neglect this! Here are the tools I use:
...
- If using X, social cards can be a bit fiddly. As of this writing, they do not show your post title, just the image. I often use Canva to write the post's title in the image [like this](https://hamel.dev/blog/posts/audience/content_2.png).
- Social media can be distracting, so I like to schedule my posts in advance so I can focus. I use [typefully](https://typefully.com/) to schedule posts across different platforms.  Some of my friends use [hypefury](https://hypefury.com/).

Finally, when posting on X, threads can be a great way to raise the visibility of your content. A simple approach is to take screenshots or copy-paste snippets of your content. Then, walk through them in a thread, as you would want a reader to.  Jeremy Howard does a [great job](https://x.com/jeremyphoward/status/1818036923304456492) [at this](https://x.com/jeremyphoward/status/1831089138571133290).  
