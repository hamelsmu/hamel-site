...
We want to gauge interest so we know how to structure this course (format, timing, syllabus etc). If you are interested, please sign up below.  We will send you updates as we develop [the course](https://k8scourse.com/).
...
[^5]: It's likely that many places are still not using K8s, but the trend is firmly towards widespread adoption.
