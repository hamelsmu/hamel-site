...
You want to generate enough data so that you have at least ~30 examples for each combination of dimension (in this toy example: features, scenarios, and personas).  However, you also want to keep generating more data until you feel like you have stopped seeing new failure modes.  The amount of data I generate varies significantly depending on the use case.
