...
The best tools don't try to automate away the human; they empower them. Since error analysis is the highest ROI activity in AI engineering, a tool's ability to support efficient human review is paramount. Prioritize tools with first-class support for manual annotation and error analysis.  As of this writing, one thing that is missing from many tools is [axial coding](blog/posts/evals-faq/index.qmd#why-is-error-analysis-so-important-in-llm-evals-and-how-is-it-performed).
...
As for me personally, I tend to use these tools as a backend data store and use Jupyter notebooks as well as my own [custom built](blog/posts/evals-faq/index.qmd#should-i-build-a-custom-annotation-tool-or-use-something-off-the-shelf) annotation interfaces for most of my needs.
