...
This method is so simple that it might seem uncool.  You aren't going to impress any data scientists but, it's too valuable to ignore.
:::
...
You can take this approach further by adding embeddings to your features to detect semantic drift further.  Similarly, you could add additional features by hand like the number of conversation turns, length of messages, etc.  
