...
author: Hamel Husain
date: 2025-03-24
image: images/field_guide_2.png
---
...
1. [Why focusing on tools over process is killing your AI projects](#the-most-common-mistake-focus-on-tools-over-process)
2. [How error analysis consistently reveals the highest-ROI improvements](#everyone-skips-error-analysis-and-its-the-highest-roi-activity)
3. [Why a simple data viewer is your most important AI investment](#the-most-important-ai-investment-a-simple-data-viewer)
4. [How to empower domain experts (not just engineers) to improve your AI](#empower-domain-experts-to-write-prompts)
5. [Why synthetic data is more effective than you think](#bootstrapping-your-ai-with-synthetic-data-is-effective-even-with-zero-users)
6. [How to maintain trust in your evaluation system](#maintaining-trust-in-evals-is-critical)
7. [Why your AI roadmap should count experiments, not features](#your-ai-roadmap-should-count-experiments-not-features)
