...
That's it - your app should be running on the Dokku host!  Your local logs will print the URL that your application is served on, which by default will be `myapp.yourdomain.com`. You can scale it up/down with the following command (and do a whole lot more):
