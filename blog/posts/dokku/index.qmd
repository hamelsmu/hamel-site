...
**I run a Dokku server on a $7/month VPS on [OVHcloud](https://us.ovhcloud.com/)** for non-gpu workloads. These applications include things like [nb-sanity](https://nb-sanity.com/) and [data cleaning tools for LLMs](https://langfree.parlance-labs.com/tutorials/shiny.html#run-the-shiny-app-locally). 
