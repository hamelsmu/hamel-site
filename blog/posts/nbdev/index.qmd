...
I worked on [nbdev](https://nbdev.fast.ai) from 2020-2023 with [Jeremy Howard](https://github.com/jph00) and later with [Wasim Lorgat](https://github.com/seem).  I had the privilege and excitement of exploring the boundaries of developer tools and exploratory programming while working with very talented software engineers.  In addition to creating a tool many people enjoyed, I [enjoyed using nbdev](https://nbdev.fast.ai/blog/posts/2022-07-28-nbdev2/) for personal and professional projects.
...
[^8]: We have partnered with Posit and [JJ Allaire](https://en.wikipedia.org/wiki/Joseph_J._Allaire) and built nbdev on top of [Quarto](https://quarto.org/).  I'm currently advising Posit on their product and strategy.  They have additional projects on their roadmap that I cannot disclose now.
