---
title: "Q: What parts of evals can be automated with LLMs?"
categories: [LLMs, evals, faq, faq-individual]
date: last-modified
image: images/eval_faq.png
aliases:
  - /evals-faq/what-parts-of-evals-can-be-automated-with-llms
...
[↩ Back to main FAQ](/blog/posts/evals-faq/#q-what-parts-of-evals-can-be-automated-with-llms){target="_blank" .faq-back-link}

[↩ Back to main FAQ](/blog/posts/evals-faq/#q-what-parts-of-evals-can-be-automated-with-llms){.faq-back-link}
