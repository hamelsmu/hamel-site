## Q: Are similarity metrics (BERTScore, ROUGE, etc.) useful for evaluating LLM outputs? [↗](/blog/posts/evals-faq/are-similarity-metrics-bertscore-rouge-etc-useful-for-evaluating-llm-outputs.html){.faq-link-icon}
