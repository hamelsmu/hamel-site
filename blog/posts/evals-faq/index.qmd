...
**2. Step-level diagnostics.** Assuming that you have sufficiently [insturmented your system](https://hamel.dev/blog/posts/evals/#logging-traces) with details of tool calls and responses, you can score individual components such as:
...
When I help clients with vendor selection, the decision weighs heavily towards who can offer the best support, as opposed to features.  This changes depending on size of client, use case, etc. Yes - its mainly the human factor that matters, and dare I say, vibes.

I have no favorite eval vendor.  At the core, their features are very similar - and I often build [custom tools](https://hamel.dev/blog/posts/evals/#q-should-i-build-a-custom-annotation-tool-or-use-something-off-the-shelf) on top of them to fit my needs. 
