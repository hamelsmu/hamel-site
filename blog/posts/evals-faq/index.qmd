...
- **Metric-based sorting:** Even though we advise against using [off-the-shelf metrics](#q-should-i-use-ready-to-use-evaluation-metrics) for evaluation, they can serve as exploration signals to find interesting traces. Review both high and low scores and treat them as exploration signals, not truth.  Based on what you learn from looking at these traces, you can build custom evaluators for the failure modes you find.
