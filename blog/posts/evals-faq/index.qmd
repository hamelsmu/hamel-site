...
Keep your data annotation interface minimal and only add features as you need them. You should only incoproate these ideas if they provide a benefit that outweighs the additional complexity and maintenance overhead.
