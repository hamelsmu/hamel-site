...
![A custom interface for reviewing emails for a real estate assistant.](2025-06-18-17-28-27.png)
...
![An annotation interface with a progress bar and hotkey guide](2025-06-18-19-44-34.png)
...
![Cluster view showing groups of emails, such as property-focused or client-focused examples. Reviewers can drill into a group to see individual traces.](2025-06-18-17-31-12.png)

**5. Bring action closer to review.**  Send traces flagged by failed guardrails, CI failures, or automated evaluator disagreement to the front. Make it one click to “send to dataset,” file a bug, or re-trigger a pipeline run. Show pipeline/code version, eval scores, and reviewer info and any other relevant info inline. Below is an illustration of these ideas:

![A trace with a flag for CI, auto-evaluator verdicts, and pipeline version](2025-06-18-19-58-24.png)
