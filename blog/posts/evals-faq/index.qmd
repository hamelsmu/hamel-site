...
If are **completely new** to product-specific LLM Evals (not foundation model benchmarks), see these posts: [part 1](https://hamel.dev/evals), [part 2](https://hamel.dev/llm-judge/), [part 3](https://hamel.dev/evals/field-guide).  Otherwise, keep reading.

## What is the best way to evaluate my LLM?
