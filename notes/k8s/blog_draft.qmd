...
description: Learning K8s can give you an unreasonable advantage as a data scientist and unblock your teams.
categories: [K8s]
image: https://user-images.githubusercontent.com/1483922/208368976-37ea8413-7102-4e17-97f1-0832c7a071c8.png
order: 0
---

This will become a blog post with the title: 
"Why Should Data Scientists Learn Kubernetes?"
"Learning K8s can give you an unreasonable advantage as a data scientist and unblock your teams."
...
My DevOps friend [Michał Jastrzębski](https://twitter.com/_inc0_) who specializes in ML infrastructure, has shared the following colorful anecdotes with me:

1. When I hear “Data Scientists shouldn’t learn K8s”, I hear “DevOps needs to learn Airflow”.
2. Do you really want to try to force a team that is chronically understaffed to try to help you stand up basic tools?
3. DevOps people don’t want anything to do with maintaining critical infra installed on a VM
4. Can data scientists meet DevOps halfway and learn a common API that we can both understand?
...
For simple apps that you want to stand up quickly or prototype, K8s is likely overkill. Instead, I'm advocating knowledge of K8s as useful when working within the environments found in many companies.  For example, if you want to deploy production software, hosting your data product on a single VM is often insufficient.  Many companies even have infrastructure that may block you from doing this with paved paths that only include Kubernetes.
