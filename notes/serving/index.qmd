...
:::{.callout-note}
I discovered [a great article from Chip Huyen](https://huyenchip.com/2021/09/07/a-friendly-introduction-to-machine-learning-compilers-and-optimizers.html) after I wrote much of these notes, but then later filled my notes in with interesting bits I found in her article.
:::
...
4. Translating framework code to various backend hardware is a non-trivial problem
5. New types of architectures can perform very poorly on hardware without the right compilers, even when those models are significantly smaller and simpler than established models.  One example is shared by Google [researchers who tried to implement capsule networks](https://dl.acm.org/doi/pdf/10.1145/3317550.3321441).
