...
description: How to customize the style and definitions for syntax highlighting, including adding new languages.
---
...
These color themes are defined by `json` files with the schema [defined here](https://docs.kde.org/stable5/en/kate/katepart/color-themes.html).  However, it is recommended that you choose [one of the themes that quarto already provides](https://github.com/quarto-dev/quarto-cli/tree/main/src/resources/pandoc/highlight-styles) and edit that.  By default, Quarto uses the [`arrow-light`](https://github.com/quarto-dev/quarto-cli/blob/main/src/resources/pandoc/highlight-styles/arrow-light.theme) theme.  This means if you are happy with the way Quarto is highlighting syntax, you can just tweak this theme.  Personally, my favorite theme is [darcula](https://github.com/quarto-dev/quarto-cli/blob/main/src/resources/pandoc/highlight-styles/dracula.theme).  It is useful to look through these different themes to get a sense of the types of things you can change.
