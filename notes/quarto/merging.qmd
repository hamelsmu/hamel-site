...
The yaml file is a [listing from data](listings-from-data.qmd) while `blog/posts` is a [Quarto posts directory](https://quarto.org/docs/websites/website-blog.html#posts-directory) of blog posts.
