...
desc: Examle of how to generate listings for external blog posts
---
...
And in the front matter of a page, like `index.qmd` you can reference `blogs.yml` and `_metadata.yml`:
...
[Here is]https://hamelsmu.github.io/minimal-site/) a minimal example of creating an index page of all your blog posts. It uses slightly different options than I did in the above example. You can see the code for [that here](https://github.com/hamelsmu/minimal-site).  
