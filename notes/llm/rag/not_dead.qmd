...
| [![](p7-images/graph_db_meme.jpg){width=100px}](p7-graph-db.qmd) | [Part 7](p7-graph-db.qmd): **You Don't Need a Graph DB (Probably)** | Jo Kristian Bergum explains why graph databases are usually overkill for RAG |
