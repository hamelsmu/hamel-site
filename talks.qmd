...
description: A list of courses and talks I've given.
sidebar: false
aliases:
  - /teaching
---
...
- [Improving LLM Applications With Evals (Currently Teaching)](https://maven.com/parlance-labs/evals): A 4 week intensive course on how to improve LLM applications with evals.

- [Mastering LLMs](blog/posts/course/index.qmd): A survey course on LLMs, covering topics like evals, RAG, fine-tuning, prompt engineering, and more. (July 2024)

- [AI Essentials For Tech Executives](https://ai-execs.com/): A course for tech executives on AI, informed by working with 30 + companies. (January 2025)

# 🎤 Talks

These are a list of talks I've given:

- [How to Construct Domain Specific LLM Evaluation Systems](https://www.youtube.com/watch?v=eLXF0VojuSs), AI Engineering World's Fair, June 2024.

- [Building Real-World LLM Products with Fine-Tuning](https://twimlai.com/podcast/twimlai/building-real-world-llm-products-with-fine-tuning-and-more/), TWIML AI Podcast, June 2024.
