...
Below is an annotated version of [his presentation](https://maven.com/p/933026/you-don-t-need-a-graph-db?utm_medium=ll_share_link&utm_source=instructor).


![](../notes/llm/rag/p7-images/intro_slide.jpg)
...
![Meme about being pitched a graph database](../notes/llm/rag/p7-images/graph_db_meme.jpg)
...
![The information retrieval process](../notes/llm/rag/p7-images/ir_process.jpg)
...
![1 million tokens is about 3MB, the size of a floppy disk](../notes/llm/rag/p7-images/context_window_floppy.jpg)
...
![Knowledge graphs are triplets: (source, relationship, target)](../notes/llm/rag/p7-images/knowledge_graph_triplets.jpg)
...
![Evaluation metrics: MRR, Precision, Recall](../notes/llm/rag/p7-images/evaluation_slide.jpg)
...
![Key questions before adding a graph database](../notes/llm/rag/p7-images/graph_db_questions.jpg)
...
![No single silver bullet](../notes/llm/rag/p7-images/no_silver_bullet.jpg)
...
![](../notes/llm/rag/p7-images/hornet_cta.jpg)
