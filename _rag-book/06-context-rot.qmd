---
title: "Context Rot: When Long Context Windows Fail"
...
[Kelly Hong](https://www.linkedin.com/in/kellyhong/){target="_blank"} is a researcher at Chroma who investigates how LLMs handle long-context inputs. Despite marketing claims that models with 1M+ token context windows make RAG obsolete, Kelly's [research](https://research.trychroma.com/context-rot){target="_blank"} reveals that performance degrades significantly as context length increases—a phenomenon she coined "Context Rot." Her experiments across 18 state-of-the-art models show that simply having information in context isn't enough; how that information is presented matters critically for reliable AI applications.
